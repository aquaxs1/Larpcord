...
export const enum IpcEvents {
    ...
    // Larpcord
    LARP_SET_LOCALE = "LARP_SET_LOCALE",
    LARP_GET_VIEW_STRINGS = "LARP_GET_VIEW_STRINGS",
    LARP_LOCALE_CHANGED = "LARP_LOCALE_CHANGED",

    LARP_UPDATER_GET_STATUS = "LARP_UPDATER_GET_STATUS",
    LARP_UPDATER_STATUS = "LARP_UPDATER_STATUS",
    LARP_UPDATER_CHECK = "LARP_UPDATER_CHECK",
    LARP_UPDATER_SET_OPTIONS = "LARP_UPDATER_SET_OPTIONS",
    LARP_UPDATER_INSTALL = "LARP_UPDATER_INSTALL",
    LARP_UPDATER_DISMISS = "LARP_UPDATER_DISMISS",

    LARP_ONBOARDING_GET_INFO = "LARP_ONBOARDING_GET_INFO",
    LARP_ONBOARDING_FINISH = "LARP_ONBOARDING_FINISH",
    LARP_ONBOARDING_QUIT = "LARP_ONBOARDING_QUIT",
    LARP_ONBOARDING_CONSUME = "LARP_ONBOARDING_CONSUME",

    LARP_MUSIC_LIST = "LARP_MUSIC_LIST",
    LARP_MUSIC_CHOOSE = "LARP_MUSIC_CHOOSE",
    LARP_MUSIC_DELETE = "LARP_MUSIC_DELETE"
}
